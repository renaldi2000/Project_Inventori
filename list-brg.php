...
$query = mysqli_query($koneksi, "SELECT id, nama_barang, jumlah_barang, harga_satuan, harga_satuan * jumlah_barang as total 
FROM barang");
...
<section>
    <div class="form">
    <a href="add-brg.php" class='tambah'> + Tambah Data Barang</a>
    <form action="search-brg.php" method="get">
    ...
    <table border="2" width="100%" height="10%">
        <tr>
            <th colspan="5" height='60px'>DATA BARANG</th>
        </tr>
        <tr height="50px">
        ...
        <tr> 
            ...
            <td><p><?php echo $result['jumlah_barang']?> pcs</p></td>
            <td><p>Rp. <?php echo $result['harga_satuan']?></p></td>
            <td><p>Rp. <?php echo $result['total'];?></p></td>    
            <td height="50px">
                <a class='edit' href="edit-brg.php?id=<?php echo $result['id']?>">Edit Data</a>
                <a onclick= "return confirm('Yakin Ingin Hapus Data?')" class="delete" href="delete-brg.php?id=<?php echo $result['id']?>">Hapus Data</a>
            </td>
        </tr>
        <?php endforeach;?>
    </table>
