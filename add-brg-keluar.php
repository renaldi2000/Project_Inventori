...
<section>
    <div class="form">
        ...
        <br>
            <form action="insert-brg-keluar.php" method="post">
                <label for="tgl_transaksi">Tgl Transaksi :</label>
                <br><br>   
                <input type="date" name="tgl_transaksi" id="" required>
                <br><br>
                <label for="nama_karyawan">Nama karyawan :</label>   
                <br><br>
                <input type="text" name="nama_karyawan" id="" required>
                <br><br>
                <label for="nama_barang">Nama Barang :</label>   
                <br><br>
                <input type="text" name="nama_barang" id="" required>
                <br><br>
                <label for="jummlah_barang-keluar">Jumlah Barang Keluar :</label>   
                <br><br>
                <input type="text" name="jumlah_barang_keluar" id="" required>
                <br><br>
                <div>
