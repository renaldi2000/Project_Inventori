...
$query = mysqli_query($koneksi,"SELECT * FROM barang_masuk WHERE nama_barang ='$keyword'");
...
<section>
    ...
    <table border="3" width='100%' height='20%'>
        <tr>
            <th colspan="5" height='60px'>DATA BARANG MASUK</th>
        </tr>
        <tr height="50px">
            <th width="200px">Nama Barang</th>
            <th width="200px">Jumlah Barang Masuk</th>
        </tr>
