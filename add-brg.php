...
<section>
    <div class="form">
        ...
        <br>
            <form action="insert-brg.php" method="post">
                ...
                <br><br>
                <input type="text" name="jumlah_barang" id="">
                <br><br>
                <label for="harga_satuan" name='no_tlp'>Harga Satuan :</label>
                <br><br>
                <input type="text" name="harga_satuan" id="" required>
                <br><br>
                <div>
