...
<section>
    <div class="form">
    <a href="add-brg-keluar.php" class='tambah'> + Tambah Data Barang Keluar</a>
    <form action="search-brg-keluar.php" method="get">
    ...
    <table border="2" width="100%" height="10%">
        <tr>
            <th colspan="5" height='60px'>DATA BARANG KELUAR</th>
        </tr>
        <tr height="50px">
        ...
        <tr> 
            ...
            <td><p><?php echo $result['jumlah_barang_keluar']?> pcs</p></td>
            <td height="50px">
                <a class='edit' href="edit-brg-keluar.php?id=<?php echo $result['id']?>">Edit Data</a>
                <a onclick= "return confirm('Yakin Ingin Hapus Data?')" class="delete" href="delete-brg-keluar.php?id=<?php echo $result['id']?>">Hapus Data</a>
            </td>
        </tr>
        <?php endforeach;?>
    </table>
