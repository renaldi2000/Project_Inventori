...
<section>
    <div class="form">
    <a href="add.php" class='tambah'> + Tambah Data Supplier</a>
    ...
    <table border="2" width="100%" height="10%">
        <tr>
            <th colspan="5" height='60px'>DATA SUPPLIER</th>
        </tr>
        <tr height="50px">  
        ...
        <tr> 
            ...
            <td height="50px">
                <a class='edit' href="edit.php?id=<?php echo $result['id']?>">Edit Data</a>
                <a onclick= "return confirm('Yakin Ingin Hapus Data?')" class="delete" href="delete.php?id=<?php echo $result['id']?>">Hapus Data</a>
            </td>
        </tr>
        <?php endforeach;?>
    </table>
